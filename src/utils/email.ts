...
const GOOGLE_SECRET: string = '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';
...
// const server: string = 'https://studentbe1.herokuapp.com';
...
export const verifiedUser = async (email: any, users: any, code: any) => {
    try {
        ...
        const mailOptions = {
            ...
            html: ` <p>
            Hello  <strong>${users.email}</strong>!
            <br/>
            <br/>
            ...
            Tahnk you for doing this...!
              <br/>
              <br/>
And here is your Secret OTP "<strong>${code}</strong>" for Logging in, Please keep it safe and save as you'd be needing it to create an Account!

            Thanks!
             <br/>
             <br/>
            Use this <strong><a
            href="${url}/api/user/${users._id}"
